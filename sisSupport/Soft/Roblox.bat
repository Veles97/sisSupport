...
powershell -Command "Write-Host '============================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '[➜] Программа: Roblox' -ForegroundColor Blue"
powershell -Command "Write-Host '[➜] Назначение: многопользовательская игра' -ForegroundColor DarkGray"
echo.
...
set "DEFAULT_PATH=C:\Tools\soft\Roblox"
...
powershell -Command "Write-Host '[⚙] Скачивание и установка Roblox через winget...' -ForegroundColor Yellow"
winget install -e --id Roblox.Roblox --location "%USER_PATH%" --silent --accept-package-agreements --accept-source-agreements
if %errorlevel% neq 0 (
...
powershell -Command "Write-Host '[✓] Модуль Roblox успешно установлен!' -ForegroundColor Green"
explorer "%USER_PATH%"
exit /b