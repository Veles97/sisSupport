...
powershell -Command "Write-Host '============================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '[➜] Программа: Discord' -ForegroundColor Blue"
powershell -Command "Write-Host '[➜] Назначение: мессенджер' -ForegroundColor DarkGray"
echo.
...
set "DEFAULT_PATH=C:\Tools\soft\Discord"
...
powershell -Command "Write-Host '[✓] Модуль Discord успешно установлен!' -ForegroundColor Green"
explorer "%USER_PATH%"
exit /b