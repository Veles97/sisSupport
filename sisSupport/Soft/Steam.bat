...
powershell -Command "Write-Host '============================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '[➜] Программа: Steam' -ForegroundColor Blue"
powershell -Command "Write-Host '[➜] Назначение: ну это steam что тут говорить' -ForegroundColor DarkGray"
echo.
...
set "DEFAULT_PATH=C:\Tools\soft\Steam"
...
powershell -Command "Write-Host '[⚙] Скачивание и установка Steam через winget...' -ForegroundColor Yellow"
winget install -e --id Valve.Steam --location "%USER_PATH%" --silent --accept-package-agreements --accept-source-agreements
if %errorlevel% neq 0 (
...
powershell -Command "Write-Host '[✓] Модуль Steam успешно установлен!' -ForegroundColor Green"
explorer "%USER_PATH%"
exit /b