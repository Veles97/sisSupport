...
powershell -Command "Write-Host '============================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '[➜] Программа: WinRAR' -ForegroundColor Blue"
powershell -Command "Write-Host '[➜] Назначение: архиватор WinRAR' -ForegroundColor DarkGray"
echo.
...
set "DEFAULT_PATH=C:\Tools\Archivers\WinRar"
...
powershell -Command "Write-Host '[⚙] Скачивание и установка WinRAR через winget...' -ForegroundColor Yellow"
winget install -e --id RARLab.WinRAR --location "%USER_PATH%" --silent --accept-package-agreements --accept-source-agreements
if %errorlevel% neq 0 (
...
powershell -Command "Write-Host '[✓] Модуль WinRAR успешно установлен!' -ForegroundColor Green"
explorer "%USER_PATH%"
exit /b