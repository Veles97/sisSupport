...
powershell -Command "Write-Host '============================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '[➜] Программа: CrystalDiskInfo' -ForegroundColor Blue"
powershell -Command "Write-Host '[➜] Назначение: Диагностика состояния HDD и SSD (S.M.A.R.T.)' -ForegroundColor DarkGray"
echo.
...
set "DEFAULT_PATH=C:\Tools\health_soft\CrystalDiskInfo"
...
powershell -Command "Write-Host '[⚙] Скачивание и установка CrystalDiskInfo через winget...' -ForegroundColor Yellow"
winget install -e --id CrystalDataLanguage.CrystalDiskInfo --location "%USER_PATH%" --silent --accept-package-agreements --accept-source-agreements
if %errorlevel% neq 0 (
...
powershell -Command "Write-Host '[✓] Модуль CrystalDiskInfo успешно установлен!' -ForegroundColor Green"
explorer "%USER_PATH%"
exit /b