...
powershell -Command "Write-Host '============================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '[➜] Программа: Recuva (Portable)' -ForegroundColor Blue"
powershell -Command "Write-Host '[➜] Назначение: Восстановление удаленных файлов' -ForegroundColor DarkGray"
echo.
...
set "DEFAULT_PATH=C:\Tools\health_soft\Recuva"
...
:: Шаг 5: Установка через winget (Portable версия)
powershell -Command "Write-Host '[⚙] Скачивание и распаковка Recuva Portable...' -ForegroundColor Yellow"
winget install -e --id Piriform.Recuva.Portable --location "%USER_PATH%" --accept-package-agreements --accept-source-agreements
if %errorlevel% neq 0 (
...
powershell -Command "Write-Host '[✓] Модуль Recuva Portable успешно установлен!' -ForegroundColor Green"
explorer "%USER_PATH%"
exit /b